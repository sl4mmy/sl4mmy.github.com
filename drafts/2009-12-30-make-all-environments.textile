...
Makefile comments start with #, just like shell scripts.  The first two lines of this Makefile define variables that can be referenced later.  You may safely assume the syntax for defining and referencing variables in Makefiles is also identical to shell scripting.
