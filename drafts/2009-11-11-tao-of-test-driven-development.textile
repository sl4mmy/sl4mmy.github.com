...
I also uploaded "starter code for parts 1 and 2 of the dojo":http://github.com/sl4mmy/presentations/tree/master/tao-of-test-driven-development/.  Although the dojo is technology-agnostic and attendees free to use any language, the starter code uses Java, JUnit and Ant.
